...
{
    public class PositionHistoryViewComponent : ViewComponent
    {
        readonly IHistoryAppService _historyAppService;
        public PositionHistoryViewComponent(IHistoryAppService historyAppService)
        {
        ...
        {
            return Task.FromResult(_historyAppService.AllPositionByPerson(personId));
        }
    }
}
